...
<a  href='<?php echo Yii::app()->theme->config->topLandscapeUrl ?>' class="box-square">
	<div class="text">
		<div class="arrow">
		</div>
		<p>
			<?php echo Yii::app()->theme->config->topLandscapeText ?>
		</p>
	</div>
	<div class="shadow">
	</div>
...
<a  href='<?php echo Yii::app()->theme->config->topPortraitUrl ?>' class="box-rectangle">
	<div class="text">
		<div class="arrow">
		</div>
		<p>
...
<a href='<?php echo Yii::app()->theme->config->bottomPortraitUrl ?>' class="box-rectangle-2">
	<div class="text">
		<div class="arrow">
		</div>
		<p>
...
<a href='<?php echo Yii::app()->theme->config->bottomLandscapeUrl ?>' class="box-square-2">
	<div class="text">
		<div class="arrow">
		</div>
		<p>
			<?php echo Yii::app()->theme->config->bottomLandscapeText ?>
		</p>
	</div>
	<div class="shadow">
	</div>
...
<!-- 
<div class="clearfix category-images">




	
	<div class='landscape visible-phone'>
	...
	<div class='landscape visible-phone'>
		...
		<div>
			<div class='content'>
				...
				<p>
					<span class='line'></span>
					<span><?php echo Yii::app()->theme->config->topPortraitText ?></span>
					<span class='line'></span>
				</p>
			</div>
		</div>
	...
	<div class='landscape visible-phone'>
		...
		<div>
			<div class='content'>
				...
				<p>
					<span class='line'></span>
					<span><?php echo Yii::app()->theme->config->bottomPortraitText ?></span>
					<span class='line'></span>
				</p>
			</div>
		</div>
